...
export default function Page() {
      ...
      <div className="row row-cols-1 row-cols-lg-2">
        <div className="col align-self-center">
          ...
          <p className="text-white lead">
            Eleve sua experiência de RPG de mesa no Discord com o Mini Kraken!
            Nossa ferramenta exclusiva foi projetada para aprimorar suas sessões
            de jogo, seja em sistemas como Ordem Paranormal (OP), Dungeons &amp;
            Dragons (D&amp;D), Tormenta20 (T20) e Gaia, proporcionando uma
            emoção incomparável.
          </p>
          <div>
            <Link
              className="btn btn-primary btn-lg link-light px-4 mt-2 mb-2"
              role="button"
              data-bss-hover-animate="pulse"
              href="https://discord.com/api/oauth2/authorize?client_id=899421595125288961&permissions=8&scope=bot%20applications.commands"
              target="_blank"
            >
              Adicionar Fortuna
            </Link>
        ...
        <div className="col align-self-center">
          <Image
            className="rounded Image-fluid d-none d-sm-none d-md-inline"
            src={unaHeroLogo}
            loading="eager"
            width={100}
  ...
  <section
    style={{
      background:
        'linear-gradient(var(--bs-dark) 0%, rgba(255,255,255,0)), linear-gradient(rgba(255,255,255,0) 65%, var(--bs-dark) 100%), url("/img/geral/background/red_vibes.webp") center / cover repeat-x'
    }}
  >
    <div className="container py-4 py-xl-5">
      <h2
      ...
      <p
        className="text-center text-light"
        style={{ marginBottom: 44, marginLeft: 25, marginRight: 25 }}
      >
        O Bot feito por fãs tem o objetivo de auxiliar a jogatina do seu RPG
        favorito, não somos donos ou possuímos qualquer direito sobre os mesmos,
        somos apenas um grupo de programadores e jogadores que odeiam toda a
        matemática chata que o RPG de mesa acaba criando.
      </p>
      <div className="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3 d-flex">
        <div className="col d-flex mt-1 mb-3">
          <div
            className="card border-white border-0 shadow glass-container"
            style={{
          ...
          >
            <div className="card-body p-4">
              <div
                className="row row-cols-1 align-items-stretch"
                style={{ height: "100%" }}
              >
                <div className="col">
                  <div
                    className="d-flex d-xxl-flex justify-content-center align-items-center justify-content-xxl-center align-items-xxl-center"
                    style={{ height: 150 }}
                  >
                    <Image
                      src={logoDnd}
                      width={100}
                      alt="Ordem Paranormal no Discord"
                    />
                  </div>
                </div>
                <div className="col">
                ...
                <div className="col">
                  <p className="text-start text-light">
                    Aventuras épicas o aguardam. Em um mundo repleto de magia e
                    criaturas fantásticas, embarque em emocionantes jornadas,
                    explorando masmorras perigosas, desvendando mistérios.
                  </p>
                </div>
                <div className="col text-center d-lg-flex justify-content-lg-center align-items-lg-end">
                  <Link
                    className="btn btn-primary link-light border rounded-pill border-0"
                    role="button"
                    data-bss-hover-animate="pulse"
                    href="/sistemas/ordem.html"
                  >
          ...
          >
            <div className="card-body p-4">
              ...
              >
                ...
                <div className="col">
                  <h3 className="text-center text-white">Ordem Paranormal</h3>
                </div>
                <div className="col">
                  <p className="text-start text-light">
                    Existe uma fina membrana que&nbsp;impede o paranormal de
                    cruzar para nossa realidade, essa membrana vem se afinando e
                    o paranormal se manifestando.
                  </p>
                </div>
                <div className="col text-center d-lg-flex justify-content-lg-center align-items-lg-end">
                  <Link
                    ...
                    href="/sistemas/ordem.html"
                  >
                    Leia Mais sobre Ordem Paranormal
                  </Link>
                </div>
              </div>
            </div>
          ...
          >
            <div className="card-body p-4">
              ...
              >
                ...
                <div className="col">
                  <h3 className="text-center text-white">Tormenta20</h3>
                </div>
                <div className="col">
                  <p className="text-start text-light">
                    Um sistema de RPG Brasileiro onde temos grandes aventuras,
                    vários deuses gostosos, itens lendários sendo diversão
          ...
          >
            <div className="card-body p-4">
              ...
              >
                ...
                <div className="col">
                  <h3 className="text-center text-white">Carbon2185</h3>
                </div>
                <div className="col">
                  <p className="text-start text-light">
                    Mergulhe em uma narrativa futurista repleta de tecnologia
                    avançada, mistérios cativantes e a promessa de itens
                    lendários. Nesta emocionante aventura, explore um cenário
                    único onde a diversão é garantida para todos.
                  </p>
                </div>
                <div className="col text-center d-lg-flex justify-content-lg-center align-items-lg-end">
                  <Link
          ...
          >
            <div className="card-body p-4">
              ...
              >
                ...
                <div className="col">
                  <h3 className="text-center text-white">Gaia</h3>
                </div>
                <div className="col">
                  <p className="text-start text-light">
                    Gaia: O Prelúdio é a mais nova releitura moderna para o RPG
                    de mesa, trazendo um cenário de alta fantasia medieval no
                    mundo mágico de Auroria.
                  </p>
                </div>
                <div className="col text-center d-lg-flex justify-content-lg-center align-items-lg-end">
                  <Link
                    ...
                    href="/sistemas/ordem.html"
                  >
                    Leia Mais sobre Gaia: O Prelúdio
                  </Link>
                </div>
              </div>
            </div>
          ...
          >
            <div className="card-body p-4">
              ...
              >
                ...
                <div className="col">
                  <h3 className="text-center text-white">Personalizado</h3>
                </div>
                <div className="col">
                  <p className="text-start text-light">
                    Não encontrou o sistema que joga? tudo bem pois com o Mini
                    Kraken você consegue criar seu próprio sistema homebrew para
                    o seu servidor!
                  </p>
                </div>
                <div className="col text-center d-lg-flex justify-content-lg-center align-items-lg-end">
                  <Link
                    ...
                    href="/sistemas/ordem.html"
                  >
                    Leia Mais sobre Sistema Caseiro
                  </Link>
                </div>
              </div>
            </div>
  ...
  <section>
    <div style={{ color: "rgb(18,20,29)", marginTop: 10 }}>
      <div className="container py-4 py-xl-5">
        <div
          className="text-nowrap d-flex justify-content-center align-items-center animated-text noSelect"
          style={{
        ...
        />
        <div className="row h-100" style={{ marginTop: "-41px" }}>
          <div className="col-md-10 col-xl-8 text-center d-flex d-sm-flex d-md-flex justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center">
            <div>
              <h2 className="fw-bold text-white mb-3">Status</h2>
              <p className="text-light mb-4">
                Acompanhe em tempo real os dados de desempenho de Inanimalia
                Fortuna Tenebris Verteri - o melhor bot de RPG de mesa para
                Discord. Mantenha-se atualizado sobre o desempenho do bot e
        ...
        <div className="row gy-4 row-cols-2 row-cols-md-4 justify-content-center align-items-center">
          <div className="col">
            ...
            >
              <div className="bs-icon-xl bs-icon-circle bs-icon-primary bg-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block mb-2 bs-icon lg">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="px-3">
                ...
                <p className="text-white mb-0">Usuários</p>
              </div>
            </div>
          </div>
          <div className="col">
            ...
            >
              ...
              <div className="px-3">
                ...
                <p className="text-white mb-0">Servidores</p>
              </div>
            </div>
          </div>
          <div className="col">
            ...
            >
              ...
              <div className="px-3">
                ...
                <p className="text-white mb-0">Comandos&nbsp;</p>
              </div>
            </div>
          </div>
          <div className="col">
            ...
            >
              ...
              <div className="px-3">
                ...
                <p className="text-white mb-0">Versão</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <section
    style={{
      background:
        'linear-gradient(var(--bs-dark) 0%, rgba(255,255,255,0)), linear-gradient(rgba(255,255,255,0) 65%, var(--bs-dark) 100%), url("/img/geral/background/dnd.webp") center / cover repeat-x'
    }}
  >
    <div className="container py-4 py-xl-5">
      <h2
      ...
      <p
        ...
        style={{ marginBottom: 44, marginLeft: 25, marginRight: 25 }}
      >
        O Mini Kraken é um bot para Discord que oferece uma ampla variedade de
        funções para ajudar você em sua jornada de RPG de mesa. Role dados,
        gerencie iniciativas, crie personagens, use geradores de nomes e muito
        mais. Confira aqui apenas uma pequena amostra de tudo o que o Mini
        Kraken pode fazer por você!
      </p>
      <div className="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3 d-flex">
        <div className="col d-flex mt-1 mb-3">
          <div
          ...
          >
            <div className="card-body p-4">
              <div className="d-flex justify-content-center align-items-center align-content-center">
                <div
                  className="bs-icon-md bs-icon-circle bs-icon-primary d-flex justify-content-center align-items-center d-inline-block bs-icon"
                  style={{ background: "rgba(0,0,0,0.2)", marginBottom: 0 }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-start text-light card-text">
                Não perca tempo calculando a vida do seu personagem manualmente.
                Com o comando /editar vida, o Mini Kraken faz a matemática para
                você, permitindo que você possa se concentrar em jogar.
              </p>
            </div>
          </div>
        </div>
        <div className="col d-flex mt-1 mb-3">
          ...
          >
            <div className="card-body p-4">
              ...
              <p className="text-start text-light card-text">
                A Inanimalia Fortuna possui um sistema avançado de rolagem de
                dados, permitindo diversas combinações com o comando /d. Não
                perca mais tempo fazendo cálculos complexos, deixe o Mini Kraken
        ...
        <div className="col d-flex mt-1 mb-3">
          ...
          >
            <div className="card-body p-4">
              ...
              <p className="text-start text-light card-text">
                Organize facilmente as informações dos personagens com as Fichas
                Inteligentes. Com comandos simples, como /ficha é possível criar
                e editar fichas de personagens diretamente no bot, tornando sua
                mesa mais ágil e eficiente.
              </p>
            </div>
          </div>
        </div>
        <div className="col d-flex mt-1 mb-3">
          ...
          >
            <div className="card-body p-4">
              ...
              <p className="text-start text-light card-text">
                Selecione um entre os vários sistemas de RPG disponíveis para
                personalizar ainda mais sua campanha. Com opções como Ordem
                Paranormal, Dungeons &amp; Dragons, Carbon2185 e Tormenta, e se
                não for o suficiente crie seu próprio sistema.
              </p>
            </div>
          </div>
        </div>
        <div className="col d-flex mt-1 mb-3">
          ...
          >
            <div className="card-body p-4">
              ...
              <p className="text-start text-light card-text">
                Encontre jogadores para a sua mesa de RPG com facilidade usando
                o sistema de Divulgação de Campanhas da Fortuna. Com o comando
                /enviar campanha,
                <br />
                Não perca mais tempo procurando jogadores, deixe a Fortuna te
                ajudar!
              </p>
            </div>
          </div>
        ...
        <div className="col d-flex mt-1 mb-3">
          ...
          >
            <div className="card-body p-4">
              ...
              <p className="text-start text-light card-text">
                uma variedade de geradores de nomes e cartas para ajudar na
                criação de personagens. Com os comandos /gerar nome e /baralho,
                é possível gerar nomes aleatórios, cartas de tarô ou baralho
        ...
        <div className="col d-flex mt-1 mb-3">
          ...
          >
            <div className="card-body p-4">
              ...
              <p className="text-start text-light card-text">
                Um amplo sistema de Economia chamado de KC (Kraken Coins) que
                pode ser conseguido de diversas formas, e será útil para funções
        ...
        <div className="col d-flex mt-1 mb-3">
          ...
          >
            <div className="card-body p-4">
              ...
              <p className="text-start text-light card-text">
                Encontre as magias e rituais do seu grimorio&nbsp; com mais
                facilidade com nosso livro de magias que permite pesquisa em
                tempo real!
              </p>
            </div>
          </div>
        ...
        <div className="col d-flex mt-1 mb-3">
          ...
          >
            <div className="card-body p-4">
              ...
              <p className="text-start text-light card-text">
                O que será que teremos aqui? bem esse definitivamente é um
                mistério&nbsp;
              </p>
            </div>
          </div>
  ...
  <section className="d-xl-flex justify-content-xl-center" id="premium">
    <div className="container">
      <div className="row">
        <div className="col">
          <h2 className="text-center text-light">Doe &amp; apoie o Projeto</h2>
          <p className="text-center text-light m-2 p-2">
            O Mini Kraken é e sempre será gratuito, entretanto criamos o
            programa de apoiadores com o objetivo de nos ajudar a arcar com as
            despesas hospitalares da Una
            <br />
            que atualmente vive a base de maquinas, onde caso sejam desligadas
            ela morre. então doe e ajuda a Una a ficar viva por mais um dia!
          </p>
        </div>
      </div>
      <div className="row g-0 justify-content-center align-items-center">
        <div
          className="col-xxl-12 box"
          style={{ paddingBottom: 0, marginTop: "auto", marginBottom: 26 }}
        >
          <div className="content">
            ...
            <p>
              Premium pessoal, para aqueles que desejam se aventurar em novas
              funções!
            </p>
            <ul
              className="list-unstyled justify-content-xxl-start"
            ...
            >
              <li style={{ marginBottom: 5 }}>
                ...
                &nbsp;2 Milhões de Kc (comprador)
              </li>
              <li style={{ marginBottom: 5 }}>
                <i className="fas fa-key" />
                &nbsp;Desbloqueie funções premium
              </li>
              <li style={{ marginBottom: 5 }}>
                <i className="far fa-address-card" />
                &nbsp;Cargo doador em nosso Discord
              </li>
              <li style={{ marginBottom: 5 }}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <li style={{ marginBottom: 5 }}>
                ...
                &nbsp;+2 slots de Personagens&nbsp;(em breve)
              </li>
              <li style={{ marginBottom: 5 }}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                &nbsp;Prioridade em pedidos &amp; suporte
              </li>
            </ul>
            <h3 id="price-1" style={{ marginBottom: 0, marginTop: 10 }}>
              R$5/mês
            </h3>
            <Link
              className="d-flex d-md-flex d-lg-flex d-xxl-flex justify-content-center justify-content-md-center align-items-md-center justify-content-lg-center align-items-lg-center justify-content-xxl-center align-items-xxl-center"
              href="#"
              style={{ marginTop: 15 }}
            >
              Apoiar Projeto
        ...
        >
          <div className="content">
            ...
            <p>
              Um por todos e todos por um, com esse plano todos em seu servidor
              ganham benefícios!{" "}
            </p>
            <ul
              className="list-unstyled justify-content-xxl-start"
            ...
            >
              ...
              <li style={{ marginBottom: 5 }}>
                ...
                &nbsp;Crie seu próprio sistema&nbsp;(em breve)
              </li>
            </ul>
            <h3 id="price-3" style={{ marginBottom: 0, marginTop: 10 }}>
              R$7/mês
            </h3>
            <Link
              className="d-flex d-md-flex d-lg-flex d-xxl-flex justify-content-center justify-content-md-center align-items-md-center justify-content-lg-center align-items-lg-center justify-content-xxl-center align-items-xxl-center"
          ...
          <div className="content">
            ...
            >
              ...
              <li style={{ marginBottom: 5 }}>
                ...
                &nbsp;Materiais &amp; Playtests exclusivos
              </li>
              <li style={{ marginBottom: 5 }}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <li style={{ marginBottom: 5 }}>
                ...
                &nbsp;Packs do pé da equipe
              </li>
              <li style={{ marginBottom: 5 }}>
                <i className="fas fa-heart" />
                &nbsp;Acesso ao <strong>OnlyFans</strong> da Fortuna
              </li>
              <li style={{ marginBottom: 5 }}>
                <i className="fas fa-key" />
                &nbsp;Todos os benefícios dos demais premiums em até 4
                servidores.
              </li>
              <li style={{ marginBottom: 5 }}>
                <svg
                ...
                &nbsp;Licença poética para cobrar os desenvolvedores
              </li>
            </ul>
            <h3 id="price-2" style={{ marginBottom: 0, marginTop: 10 }}>
              R$15/mês
            </h3>
            <Link
              className="d-flex d-md-flex d-lg-flex d-xxl-flex justify-content-center justify-content-md-center align-items-md-center justify-content-lg-center align-items-lg-center justify-content-xxl-center align-items-xxl-center"

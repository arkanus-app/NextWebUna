...
export default function LocaleSwitcher() {
  ...
  return (
    <label>
      <li className={"nav-item dropdown"}><a className={"dropdown-toggle nav-link me-1"} aria-expanded="false" data-bs-toggle="dropdown" href="#">{t('lang')}<svg className={"ms-1"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
